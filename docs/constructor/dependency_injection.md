...
Наш `ProfileCommand` остается таким же чистым. Он не знает о существовании контейнера. Он просто декларирует необходимые ему сервисы. Есть два основных способа это сделать:
